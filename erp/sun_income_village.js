/* Sun village operations v1.0.2 — internal village identifiers are server-generated and never requested from users. */
(() => {
  'use strict';
  const VERSION = '1.0.2';
  ...
  function friendly(error) {
    ...
    if(error?.code==='23505') return '같은 달의 자료가 이미 등록되어 있습니다. 목록에서 기존 자료를 찾아 수정해 주세요.';
  ...
  function snapshotHtml(row){
    ...
    const labels={name:'이름',address:'주소',display_name:'담당자',role:'운영 권한',active:'사용 여부',access_level:'자료 접근',can_approve:'결재권',version:'버전'};
